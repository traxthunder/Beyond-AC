...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 1, 4294967295, '', 'prewritten', False, 'Company Log -Under Command of Will Bounder, Captain
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 6, 4294967295, '', 'prewritten', False, ' There were whispers and looks; but none moved; none save Captain Bounder. He looked at us, walked through our number, Verily it was as if he could see into our souls in that moment. The calls of the Noble drowned away as the Captain approached him and dropped the purse containing the payment at his feet. '
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 7, 4294967295, '', 'prewritten', False, ' I truthfully do not know what he said to us, only of the two things that followed, The Nobleman’s Guard moved toward the Captain, and in minutes they were all slain. And for the first time in six long years we were welcomed into a town as friends.
It is sure that the Nobles will seek revenge, but for now it feels like things have changed for us.
');

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 8, 4294967295, '', 'prewritten', False, ' 1281 RC Leafcull
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 9, 4294967295, '', 'prewritten', False, ' Those who went on supply runs have heard rumors, and not ones to ignore. The other Nobles will come for us upon the first thaw, we must be ready or gone. I fear what that will mean for the people here.'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 10, 4294967295, '', 'prewritten', False, ' 1281 RC Snowreap
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 11, 4294967295, '', 'prewritten', False, ' 1281 RC Wintersebb
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 12, 4294967295, '', 'prewritten', False, ' I am not the only one thinking the same. My comrades can hardly smile, looking knowingly into each other’s eyes and marking the losses we have already taken. The Captain has been quiet. But we know the look in his eyes as well as he knows ours. '
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 13, 4294967295, '', 'prewritten', False, ' 1281 RC Morningthaw
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 15, 4294967295, '', 'prewritten', False, ' 1281 RC Seedsow 
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 16, 4294967295, '', 'prewritten', False, ' 1281 RC Leafdawning
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 17, 4294967295, '', 'prewritten', False, ' We have lost some to the fight as well, more native to the town then our seasoned fighters. Two of the Elders sought to make an agreement with the Nobles, and with their heads on pikes the town is looking more to the Captain for leadership now. 
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 18, 4294967295, '', 'prewritten', False, ' The pages here are faded to illegible to read.'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 19, 4294967295, '', 'prewritten', False, ' 1282 RC Solclaim
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 20, 4294967295, '', 'prewritten', False, 'I don’t even know how many of us are left anymore. Once hell broke loose and we had to flee there was little we could do. We have lost so many. Less then 1500 Still travel with us. And probably half of the company remains. 
We are hounded every step of the way, our rear guard soaking up assault after Assault. 
');

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 21, 4294967295, '', 'prewritten', False, ' The script changes slightly, a more practiced hand perhaps.'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 22, 4294967295, '', 'prewritten', False, ' Company Log -Under Command of Will Bounder, Captain 16th Company
Recorded By K Skye
1282 RC Seedsow
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 23, 4294967295, '', 'prewritten', False, ' 1131 refugees from town have survived the journey. And 241 still answer to the Company. We have started fortifications and stockpiling of supplies as well as rationing. Any name of note among us has had a price put upon their heads, though we are all Targets.'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 24, 4294967295, '', 'prewritten', False, '1282 RC Thistledown
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 25, 4294967295, '', 'prewritten', False, ' A few soldiers of the company have taken spouses with the refugees or adopted the orphaned children as their own. We look more like a rag tag traveler company then a fighting machine to me. 
Still the supplies level is high and we are safe.
');

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 26, 4294967295, '', 'prewritten', False, ' -Damage to the pages over time'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 27, 4294967295, '', 'prewritten', False, '1283 RC Snowreap
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 28, 4294967295, '', 'prewritten', False, ' -Damage to the pages over time'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 29, 4294967295, '', 'prewritten', False, ' 1283 RC Verdantine
);
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 30, 4294967295, '', 'prewritten', False, ' 
1283 RC Thistledown
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 31, 4294967295, '', 'prewritten', False, ' 1283 RC Thistledown
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 32, 4294967295, '', 'prewritten', False, ' 1283 RC Thistledown
...
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 33, 4294967295, '', 'prewritten', False, ' -The Script changes, a scratchy scrawl but carefully written note on the Page'
);
INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5000316, 34, 4294967295, '', 'prewritten', False, ' 1283 RC Thistledown
