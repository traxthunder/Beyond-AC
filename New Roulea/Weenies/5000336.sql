...
VALUES (5000336,   1,   33560229) /* Setup */
     ...
     , (5000336,  32,        199) /* WieldedTreasureType - 
                                   Wield Yumi (23733) | Shade: 0 | Probability: 6%
                                   Wield 20x Deadly Armor Piercing Arrow (15431) | Shade: 0 | Probability: 100%
                                   Wield Yumi (23733) | Shade: 0 | Probability: 6%
                                   Wield 17x Deadly Arrow (15429) | Shade: 0 | Probability: 100%
                                   Wield Heavy Crossbow (23664) | Shade: 0 | Probability: 6%
                                   Wield 20x Deadly Quarrel (15438) | Shade: 0 | Probability: 100%
                                   Wield Heavy Crossbow (23664) | Shade: 0 | Probability: 6%
                                   Wield 16x Deadly Armor Piercing Quarrel (15440) | Shade: 0 | Probability: 100%
                                   Wield Yumi (23733) | Shade: 0 | Probability: 6%
                                   Wield 20x Deadly Broadhead Arrow (15433) | Shade: 0 | Probability: 100%
                                   Wield Yumi (23733) | Shade: 0 | Probability: 6%
                                   Wield 17x Deadly Blunt Arrow (15432) | Shade: 0 | Probability: 100%
                                   Wield Heavy Crossbow (23664) | Shade: 0 | Probability: 6%
                                   Wield 20x Deadly Broadhead Quarrel (15442) | Shade: 0 | Probability: 100%
                                   Wield Heavy Crossbow (23664) | Shade: 0 | Probability: 6%
                                   Wield 16x Deadly Blunt Quarrel (15441) | Shade: 0 | Probability: 100%
                                   Wield Katar (23673) | Shade: 0 | Probability: 12%
                                   Wield Cestus (23636) | Shade: 0 | Probability: 12%
                                   Wield Nekode (23679) | Shade: 0 | Probability: 12%
                                   Wield Tachi (23699) | Shade: 0 | Probability: 12%
                                   Wield Spear (23695) | Shade: 0 | Probability: 12%
                                   Wield Fire Yaoji (23717) | Shade: 0 | Probability: 12%
                                   Wield Yaoji (23709) | Shade: 0 | Probability: 12%
                                   Wield Fire Tachi (23706) | Shade: 0 | Probability: 12%
                                   Wield Kite Shield (23683) | Shade: 0 | Probability: 75% */
     , (5000336,  35,        2105) /* DeathTreasureType - Loot Tier: 5 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (5000336,   1, 650, 0, 0) /* Strength */
     , (5000336,   2, 650, 0, 0) /* Endurance */
     , (5000336,   3, 650, 0, 0) /* Quickness */
     , (5000336,   4, 650, 0, 0) /* Coordination */
     , (5000336,   5, 650, 0, 0) /* Focus */
     , (5000336,   6, 650, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (5000336,   1, 50000, 0, 0, 50000) /* MaxHealth */
     , (5000336,   3, 50000, 0, 0, 50000) /* MaxStamina */
     , (5000336,   5, 125000, 0, 0, 125000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (5000336,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
...
VALUES (5000336,  0,  4,  0,    0, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (5000336,  5,  8, 1000, 0.15, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (5000336,  8,  8, 1000, 0.15, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (5000336,  1658,    1.5)  /* Stamina to Health Other I */
     , (5000336,  2371,   2.19)  /* Curse of Mortal Flesh */
     , (5000336,  2697,    1.8)  /* Aerfalle's Touch */
     , (5000336,  2698,    1.8)  /* Aerfalle's Embrace */
     , (5000336,  3053,    1.8)  /* Paralyzing Touch */
     , (5000336,  3084,   2.19)  /* Weaken Flesh */
     , (5000336,  4312,   2.19)  /* Incantation of Imperil Other */
     , (5000336,  4331,    1.6)  /* Incantation of Nullify All Magic Self */
     , (5000336,  4334,    1.6)  /* Incantation of Nullify All Magic Other */
     , (5000336,  5582,    1.6)  /* Nullify All Rares */;
