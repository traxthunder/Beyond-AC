...
VALUES (5000339,   1,   33560230) /* Setup */
     ...
     , (5000339,  32,        467) /* WieldedTreasureType - 
                                   Wield Stone Axe (26022) | Shade: 0 | Probability: 20%
                                   Wield Bone Dagger (26031) | Shade: 0 | Probability: 20%
     ...
     , (5000339,  35,        2101) /* DeathTreasureType - Loot Tier: 5 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (5000339,   1, 650, 0, 0) /* Strength */
     , (5000339,   2, 650, 0, 0) /* Endurance */
     , (5000339,   3, 650, 0, 0) /* Quickness */
     , (5000339,   4, 650, 0, 0) /* Coordination */
     , (5000339,   5, 650, 0, 0) /* Focus */
     , (5000339,   6, 650, 0, 0) /* Self */;
...
VALUES (5000339,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     , (5000339,  7, 0, 3, 0, 450, 0, 0) /* MissileDefense      Specialized */
     , (5000339, 15, 0, 3, 0, 275, 0, 0) /* MagicDefense        Specialized */
     ...
     , (5000339, 33, 0, 3, 0, 9000, 0, 1198.474609375) /* LifeMagic           Specialized */
     , (5000339, 34, 0, 3, 0, 800, 0, 1198.474609375) /* WarMagic            Specialized */
     , (5000339, 44, 0, 3, 0, 850, 0, 1198.474609375) /* HeavyWeapons        Specialized */
     , (5000339, 48, 0, 3, 0, 500, 0, 1198.474609375) /* Shield              Specialized */;
...
VALUES (5000339,  0,  4,  0,    0, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (5000339,  5,  8, 1000, 0.15, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (5000339,  8,  8, 1000, 0.15, 1000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (5000339, 2, 29544,  1, 93, 0, True) /* Create Marksman's Robe (29544) for Wield */
     ...
     , (5000339, 2, 666699,  1, 93, 0, True) /* Create  (666699) for Wield */
     , (5000339, 2, 30371,  1, 0, 0, True) /* Create Dread Marauder Shield (30371) for Wield */
     , (5000339, 9, 5000394,  0, 0, .2, True) /* Create Dread Marauder Shield (30371) for Wield */
     , (5000339, 9,  5000507,  0, 0, .2, True) /* Create Impious Staff (5937) for Wield */;