...
VALUES (5000797, 0.5, 1629, 240, 2, 50, 1, 4, -1, 0, 0, 0, 0, 5, 0, 1, 0, 0, 0) /* Generate  (1629) (x2 up to max of 50) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (5000797, 0.75, 1629, 240, 2, 50, 1, 4, -1, 0, 0, 0, -5, 0, 0, 1, 0, 0, 0) /* Generate  (1629) (x2 up to max of 50) - Regenerate upon Destruction - Location to (re)Generate: Specific */
     , (5000797, 1, 1629, 240, 1, 50, 1, 4, -1, 0, 0, 0, 0, -5, 0, 1, 0, 0, 0) /* Generate  (1629) (x1 up to max of 50) - Regenerate upon Destruction - Location to (re)Generate: Specific */;
